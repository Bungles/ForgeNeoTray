...
- **"Open..." submenu** for quick access to your Install Folder, Models folder, and your `img2img-images`/`txt2img-images` output folders. The two image folders also list their dated subfolders (e.g. `2026-07-28`) if any exist, so you can jump straight to a specific day
...
## Requirements
- Windows 10 or 11
- [Forge Neo](https://github.com/Haoming02/sd-webui-forge-classic/tree/neo) already installed, with a working `webui-user.bat`
